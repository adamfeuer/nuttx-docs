...
#. Fork the Apache NuttX Documentation Repository
   ...
   * `NuttX Companion <https://github.com/adamfeuer/nuttx-docs/>`_
...
#. Commit the Changes
    ...
    .. code-block:: bash
       ...
       $ git add user/intro.rst  # or whatever files you changed
       $ git commit
...
#. Submit Your Pull Request
   ...
   Go to the `Apache NuttX Documentation <https://github.com/adamfeuer/nuttx-docs/>`_ page
